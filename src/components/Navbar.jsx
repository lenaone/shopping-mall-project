  ...
  return (
    ...
    <div>
        <div className="navbar-main">
          <button className="navbar-hamburger" onClick={() => setSideMenuOpen(true)}>
            <FontAwesomeIcon icon={faBars} />
          </button>
          <div className="login-button" onClick={handleLoginClick}>
              <FontAwesomeIcon icon={faUser} />
              {isAuthenticated ? 
              <div onClick={() => setAuthenticate(false)}>로그아웃</div> : <div onClick={() => setAuthenticate(true)}>로그인</div>}
          </div>
        </div>  
        ...
        <div className="menu-area desktop">
            ...
            <div className="search-bar">
                ...
                <input className='search-bar-input' type="text" placeholder="Search..."  onKeyPress={(e)=>search(e)}/>
            </div>
        </div>  
        ...
        {sideMenuOpen && <div className="side-menu-overlay" onClick={() => setSideMenuOpen(false)}></div>}
    </div>
  )
}
